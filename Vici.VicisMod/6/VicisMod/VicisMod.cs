...
namespace VicisFCEMod.Mod {
    public class VicisMod : FortressCraftMod {
        ...
        public const VicisModVersion CURRENT_VERSION = VicisModVersion.Version6;
        ...
        private ushort quantumComputerCube;
        private ushort quantumComputerValue;
        ...
        public override ModRegistrationData Register() {
            ...
            mrd.RegisterEntityHandler(QuantumComputer.CUBE_NAME);
            ...
            quantumComputerCube = getCubeValue(QuantumComputer.CUBE_NAME);
            quantumComputerValue = getValueValue(QuantumComputer.CUBE_NAME);
        ...
        public override ModCreateSegmentEntityResults CreateSegmentEntity(ModCreateSegmentEntityParameters parameters) {
            ...
            if(parameters.Cube == quantumComputerCube) {
                if (parameters.Value == quantumComputerValue) res.Entity = new QuantumComputer(parameters);
            }
